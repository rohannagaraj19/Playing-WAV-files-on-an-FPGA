...
HD_PWD='C:/Users/rohan/Downloads/Personal_FPGA_Projects/Audio_Projects/wavPlayer/wavPlayer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wavPlayerTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wavPlayerTop.tcl
