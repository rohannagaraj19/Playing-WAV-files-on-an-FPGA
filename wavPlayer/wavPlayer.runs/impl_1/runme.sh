...
HD_PWD='C:/Users/rohan/Downloads/Personal_FPGA_Projects/Audio_Projects/wavPlayer/wavPlayer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wavPlayerTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wavPlayerTop.tcl -notrace
