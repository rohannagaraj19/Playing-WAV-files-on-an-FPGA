...
HD_PWD='C:/Users/rohan/Downloads/Personal_FPGA_Projects/Audio_Projects/wavPlayer/wavPlayer.runs/mb_block_axi_gpio_button_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_block_axi_gpio_button_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_block_axi_gpio_button_0.tcl
